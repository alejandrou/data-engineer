...
def insert_data(session, **kwargs):
    ...
    try:
        session.execute("""
            INSERT INTO spark_streams.created_users (user_id, first_name, last_name, gender,
        ...
        logging.info(f"Data inserted successfully for user {first_name}, {last_name}, {username}, {dob}, {email}, {phone}")
...
def connect_to_kafka(spark_conn):
    ...
    try:
        ...
        logging.error(f"Couldn't create the kafka dataframe due to exception {e}")
